        ...
        <script>
            $(function() {
                $('.submit').on('click', function(e) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "pageSearch.php?action=submit",
            ...
            $(function() {
                $('.delete').on('click', function(e) {
                    ...
                    $.ajax({
                        type: "GET",
                        url: "pageSearch.php?action=delete&file="+fileName,
                        success: function(response) {
                            alert(response);
                        },
                        error: function() {
            ...
            $('#exampleModal').on('show.bs.modal', function(event) {
                ...
                xhttp.open("GET", "pageSearch.php?action=read&file=" + recipient, true);
                xhttp.send();
